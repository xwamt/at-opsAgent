...
| ID | 标题 | 状态 |
|----|------|------|
| [001](001-embed-hub-in-process.md) | 进程内嵌入 Hub 引擎，而非 stdio MCP / InMemoryTransport | Accepted |
| [002](002-pi-sdk-not-fork.md) | 基于官方 pi SDK，不 fork pi-agent-studio，不绑定 pi CLI | Accepted |
