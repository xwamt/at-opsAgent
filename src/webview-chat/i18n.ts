...
const zhCN = {
  ...
  usageInput: '输入',
  usageOutput: '输出',
  composerOverflowAria: '更多输入选项',
  composerKeyHint: 'Enter 发送 · Shift+Enter 换行',
  roleUser: '你',
  roleAgent: 'Agent',
  editUserMessage: '编辑',
  ...
  historyDeleteConfirmInline: '确认删除？',
  historyDeleteConfirmBtn: '确认',
  historyDeleteCancelBtn: '取消',
  evidencePinAria: '置顶证据',
  evidenceUnpinAria: '取消置顶',
  ...
  approvalBriefOpenEditor: '在编辑器中查看',
  approvalBlankSummary: '未提供 ({count} 项)',
  approvalCommandsShowAll: '显示全部 ({count} 行)',
  approvalCommandsShowLess: '收起',
  approvalApprove: '批准',
  approvalReject: '拒绝',
  ...
  modelSelectorManage: '管理模型…',
  modelSelectorFilterPlaceholder: '过滤模型…',
  modelSelectorFilterAria: '过滤模型列表',
  modelSelectorNoMatch: '无匹配模型',
  modelSelectorProviderCustom: '自定义',
  modelSelectorCustomOption: '使用自定义模型 "{model}"',
  riskRead: '只读',
  riskWrite: '写',
  riskExec: '执行',
  ...
  toolProviderCount: '{count} 个插件',
  toolChipMore: '+{count}',
  toolHealthy: '健康',
  toolUnhealthy: '异常',
  toolFocused: '焦点',
  toolDefault: '默认',
  toolLiveTools: '{count} 个 live 工具',
  toolDeclaredTools: '{count} 个声明工具',
  ...
  subagentTranscriptEmpty: '暂无对话记录',
  subagentTranscriptEmptyStreaming: '正在分析推导与执行…',
  subagentSteps: '执行步骤',
  subagentLogs: '实时日志',
  ...
  toolLongRunning: '耗时较长',
  toolLongRunningWarning: '运行耗时较长 (>30s)，可能正在等待远程主机或网络响应',
  terminalRunningWait: '正在连接目标主机并执行命令，等待远程响应…',
  terminalRunningOnHost: '正在连接 {host} 执行命令，等待远程响应…',
  conclusionMode: '结论模式',
...
const en: Record<OpsMessageKey, string> = {
  ...
  usageStripAria: 'Session usage',
  usageContext: 'context',
  usageInput: 'in',
  usageOutput: 'out',
  composerOverflowAria: 'More input options',
  composerKeyHint: 'Enter to send · Shift+Enter for newline',
  roleUser: 'You',
  roleAgent: 'Agent',
  editUserMessage: 'Edit',
  ...
  historyDeleteConfirmInline: 'Delete?',
  historyDeleteConfirmBtn: 'Confirm',
  historyDeleteCancelBtn: 'Cancel',
  evidencePinAria: 'Pin evidence',
  evidenceUnpinAria: 'Unpin evidence',
  ...
  approvalBriefOpenEditor: 'Open in editor',
  approvalBlankSummary: 'Not provided ({count} items)',
  approvalCommandsShowAll: 'Show all ({count} lines)',
  approvalCommandsShowLess: 'Show less',
  ...
  modelSelectorManage: 'Manage models…',
  modelSelectorFilterPlaceholder: 'Filter models…',
  modelSelectorFilterAria: 'Filter model list',
  modelSelectorNoMatch: 'No matching models',
  modelSelectorProviderCustom: 'Custom',
  modelSelectorCustomOption: 'Use custom model "{model}"',
  riskRead: 'read',
  riskWrite: 'write',
  riskExec: 'exec',
  ...
  toolProviderCount: '{count} plugins',
  toolChipMore: '+{count}',
  toolHealthy: 'healthy',
  toolUnhealthy: 'unhealthy',
  toolFocused: 'focused',
  toolDefault: 'default',
  toolLiveTools: '{count} live tools',
  toolDeclaredTools: '{count} declared tools',
  ...
  subagentTranscriptTab: 'Transcript',
  subagentDebugLogs: 'Debug Logs',
  subagentTranscriptEmpty: 'No transcript available',
  subagentTranscriptEmptyStreaming: 'Analyzing and executing…',
  ...
  toolLongRunningWarning: 'Running for >30s, possibly waiting for remote host or network response',
  terminalRunningWait: 'Connecting to target host and executing, waiting for response…',
  terminalRunningOnHost: 'Connecting to {host} and executing, waiting for response…',
