...
const zhCN = {
  ...
  subagentPrevAria: '上一个子代理',
  subagentNextAria: '下一个子代理',
  saQueued: '排队',
  saRunning: '运行中',
  saOk: '完成',
  saDegraded: '降级',
  ...
  logAria: '日志输出',
  terminalTitle: '终端输出',
  terminalAutoScroll: '自动贴底',
  terminalCopyOutput: '复制输出',
  terminalCopiedOutput: '已复制输出',
  terminalRunning: '执行中…',
  terminalNoOutput: '（终端无输出）',
  terminalExitCode: '退出码',
  terminalLines: '{count} 行',
  toolDataPreview: '数据结果',
  toolSubagentDispatch: '派发子代理',
  toolSubagentDispatched: '已派发子代理',
  timelineStrip: '事件脉络',
  transcriptAria: '会话记录',
  ...
  thinkingTitle: '深度思考',
  thinkingToggleAria: '展开/收起思考过程',
  subagentSteps: '执行步骤',
  subagentLogs: '实时日志',
  subagentOverview: '任务概览',
  subagentStepRunning: '执行中',
  subagentStepDone: '已完成',
  toolRunningTimer: '正在执行',
  conclusionMode: '结论模式',
...
const en: Record<OpsMessageKey, string> = {
  ...
  subagentPrevAria: 'Previous subagent',
  subagentNextAria: 'Next subagent',
  saQueued: 'queued',
  saRunning: 'running',
  saOk: 'done',
  saDegraded: 'degraded',
  ...
  terminalCopiedOutput: 'Output Copied',
  terminalRunning: 'Executing…',
  terminalNoOutput: '(No output recorded)',
  terminalExitCode: 'Exit Code',
  terminalLines: '{count} lines',
  toolDataPreview: 'Data Result',
  toolSubagentDispatch: 'Subagent Dispatch',
  toolSubagentDispatched: 'Subagents Dispatched',
  ...
  thinkingTitle: 'Deep Reasoning',
  thinkingToggleAria: 'Toggle reasoning process',
  subagentSteps: 'Execution Steps',
  subagentLogs: 'Live Logs',
  subagentOverview: 'Overview',
  subagentStepRunning: 'Running',
  subagentStepDone: 'Completed',
  toolRunningTimer: 'Executing',
