...
const zhCN = {
  ...
  cfgWorkspaceShell: '工作区文件只读',
  cfgWorkspaceShellDesc: '允许 Agent 只读访问工作区文件（限工作区路径、单文件 64KB）。默认关闭。不提供 Shell。',
  ...
  mFetchFail: '拉取失败：',
  mSearchModelPh: '搜索模型（如 deepseek, gpt-4, claude, qwen）...',
  mSelectModel: '选择模型',
  mSelectModelFromApi: '从 API 获取并选择',
  mAlreadyAdded: '已配置',
  mSelectAll: '全选',
  mDeselectAll: '取消全选',
  mSelectUnadded: '全选未添加',
  mInvertSelect: '反选',
  mFetchedCount: '已获取',
  mSelectedCount: '已勾选',
  mBatchImportTitle: '从 API 批量导入模型',
  mBatchImportDesc: '从服务商 API 实时获取可用模型列表，勾选需要接入的模型一键批量添加。',
  mBatchAddBtn: '批量添加选中模型',
  mFilterEmpty: '未找到匹配的模型',
  mSelectFromSuggestions: '从已拉取的模型中选择',
  mClearSelection: '清空选择',
  mUseCustomModel: '使用自定义模型',
  mAddCustomToBatch: '添加自定义模型',
  mCustomModelBadge: '自定义',
  mAddCustomPh: '输入自定义模型 ID（如 deepseek-ai/DeepSeek-V3）',
  mAddBtn: '添加',
  mQuickSuggestions: '常用推荐',
  mCustomOptionPrompt: '使用自定义模型',
...
const en: Record<SettingsMessageKey, string> = {
  ...
  cfgWorkspaceShell: 'Workspace file access',
  cfgWorkspaceShellDesc: 'Allow read-only workspace file access (cwd-bound, 64KB). Off by default. Does not enable a shell.',
  ...
  mSearchModelPh: 'Search models (e.g. deepseek, gpt-4, claude, qwen)...',
  mSelectModel: 'Select Model',
  mSelectModelFromApi: 'Fetch & Select from API',
  mAlreadyAdded: 'Configured',
  mSelectAll: 'Select All',
  mDeselectAll: 'Deselect All',
  mSelectUnadded: 'Select Unadded',
  mInvertSelect: 'Invert',
  mFetchedCount: 'Fetched',
  mSelectedCount: 'Selected',
  mBatchImportTitle: 'Batch Import Models from API',
  mBatchImportDesc: 'Fetch available models from the provider API in real-time and batch-add selected models.',
  mBatchAddBtn: 'Add Selected Models',
  mFilterEmpty: 'No matching models found',
  mSelectFromSuggestions: 'Select from fetched models',
  mClearSelection: 'Clear Selection',
  mUseCustomModel: 'Use custom model',
  mAddCustomToBatch: 'Add custom model',
  mCustomModelBadge: 'Custom',
  mAddCustomPh: 'Enter custom model ID (e.g. deepseek-ai/DeepSeek-V3)',
  mAddBtn: 'Add',
  mQuickSuggestions: 'Suggested',
  mCustomOptionPrompt: 'Use custom model',
