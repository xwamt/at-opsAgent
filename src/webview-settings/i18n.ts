...
const zhCN = {
  ...
  modelsSectionApi: '连接与 API Key',
  modelsSectionCompat: '兼容性',
  modelsSectionOauth: 'OAuth 登录',
  mWizardStep1: '第 1 步 / 共 3 步：连接哪个模型服务？',
  mWizardStep1Hint: '不确定选哪个？问一下你的平台组，通常是「内部网关」。',
  mWizardStep2: '第 2 步：粘贴 API Key，然后「保存并测试」',
  mWizardStep3: '第 3 步：连接成功后回到聊天，试试第一条消息。',
...
const en: Record<SettingsMessageKey, string> = {
  ...
  modelsSectionApi: 'Connection & API Key',
  modelsSectionCompat: 'Compatibility',
  modelsSectionOauth: 'OAuth login',
  mWizardStep1: 'Step 1 of 3: Which model service do you connect to?',
  mWizardStep1Hint: 'Not sure? Ask your platform team — it is usually the internal gateway.',
  mWizardStep2: 'Step 2: Paste your API key, then “Save & test”',
  mWizardStep3: 'Step 3: Once connected, go back to chat and try your first message.',
  mProvider: 'Provider',
